...
\begin{figure}[!t]
  ...
  \end{subfigure}
  \vspace{-2mm}
  \caption{Component and capability analysis. Both anti-degeneration regularization and expectation-weighted divergence improve mining on LLaMA (a) and Qwen (b), and the MT-Bench-101 ability profile shows that SOMA's gains are spread across dialogue skills (c).}
