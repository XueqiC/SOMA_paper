...
\begin{figure}[t]
  ...
  \end{subfigure}
  \vspace{-2mm}
  \caption{Efficiency and component analysis: SOMA reduces token usage after switching (a), and both anti-degeneration regularization and expectation-weighted divergence improve mining (b).}
