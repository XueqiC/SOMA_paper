...
\definecolor{radarsur}{HTML}{CFAB72}\definecolor{radarhp}{HTML}{BDB8B0}\definecolor{radarft}{HTML}{6F6B66}\definecolor{radarsoma}{HTML}{4E9588}% shared method colours (figure/src/paper_style.py)
