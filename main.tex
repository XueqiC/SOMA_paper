...
\definecolor{radarsur}{HTML}{B7C7C3}\definecolor{radarhp}{HTML}{8A9D99}\definecolor{radarft}{HTML}{4F5F63}\definecolor{radarsoma}{HTML}{4E9588}% shared method colours (figure/src/paper_style.py)
